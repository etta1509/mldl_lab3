...
if __name__ == "__main__":
    ...
    # Load the dataset
    modify_dataset()
    tiny_imagenet_dataset_train = ImageFolder(root='./dataset/tiny-imagenet-200/train', transform=transform_2())
    tiny_imagenet_dataset_val = ImageFolder(root='./dataset/tiny-imagenet-200/val', transform=transform_2())
